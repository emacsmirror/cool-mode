;; A highly opinionated indentation mode of the COOL language. -*- no-byte-compile: t -*-
...
(defvar cool-mode-font-lock-keywords-var
...
data if you want to preserve them."
  ...
  (save-excursion
    ...
    (end-of-line)
    (cool-mode-backward-skip-comments)
    (when (looking-back regexp nil nil)
      (point))))
...
(define-derived-mode cool-mode-orig nil "Cool"
